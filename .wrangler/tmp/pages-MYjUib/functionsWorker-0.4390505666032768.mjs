...
// api/applications.js
var jsonResponse = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data, null, 2), {
  status,
  headers: {
...
var ensureDb = /* @__PURE__ */ __name((env) => env?.DB ?? null, "ensureDb");
var readBodyJson = /* @__PURE__ */ __name(async (request) => {
  try {
...
var validateApplicationPayload = /* @__PURE__ */ __name((payload) => {
...
var jsonResponse2 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data, null, 2), {
  status,
  headers: {
    "Content-Type": "application/json; charset=utf-8",
    "Cache-Control": "no-store"
...
var normalizeTournament = /* @__PURE__ */ __name((item) => ({
  id: item.id,
  title: item.title,
...
var ensureDb2 = /* @__PURE__ */ __name((env) => env?.DB ?? null, "ensureDb");
var readBodyJson2 = /* @__PURE__ */ __name(async (request) => {
  try {
    return await request.json();
  } catch {
    return null;
...
var validateTournamentPayload = /* @__PURE__ */ __name((payload) => {
  if (!payload || typeof payload !== "object") {
    return "\u30EA\u30AF\u30A8\u30B9\u30C8\u30DC\u30C7\u30A3\u3092JSON\u5F62\u5F0F\u3067\u9001\u4FE1\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
  }
...
// ../.wrangler/tmp/pages-MYjUib/functionsRoutes-0.025363351001537637.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-KJJs2Y/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-KJJs2Y/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4390505666032768.mjs.map
